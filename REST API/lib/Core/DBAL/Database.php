...
class Database {
	...
	public function getLink() {
		...
		if ( $this->link === null ) {
			...
			if ( !$this->link ) {
				throw new \Exception("Error connecting to database {$this->user}@{$this->host}. MySQL said: ".  mysqli_error());
			}
	...
	public function query($query) {
		...
		if (!$result) {
			throw new \Exception("Error executing query $query. MySQL said: ". mysqli_error($this->getLink()));
		}
